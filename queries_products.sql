...
-- INSERT INTO products (name, price, can_be_returned) VALUES ('lamp', 26.99, false);
...
-- UPDATE products SET price = 24 WHERE id = 1;
-- UPDATE products SET price = 5.99 WHERE id = 2;
-- UPDATE products SET price = 104 WHERE id = 3;
-- UPDATE products SET price = 6.99 WHERE id = 4;
